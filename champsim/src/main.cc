...
time_t start_time;
string CONFIG_FILE; // DQN socket config [Kevin]
...
int main(int argc, char** argv)
{
    ...
    cout << "L1D sets: " << L1D_SET << ". L1D ways: " << L1D_WAY << endl;
    ...
    // search through the argv for "-config" [Kevin]
